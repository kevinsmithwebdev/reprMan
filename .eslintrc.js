...
/**
 * Always pass an explicit `project` list. If `project` is omitted,
 * eslint-import-resolver-typescript uses `process.cwd()` and loads the
 * nearest tsconfig — which for client-mobile is Expo's (missing in root CI).
 */
